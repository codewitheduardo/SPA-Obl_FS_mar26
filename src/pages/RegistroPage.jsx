...
export default function Registro() {
  return (
    <section className="relative mx-auto grid min-h-[calc(100vh-3rem)] max-w-5xl items-center gap-10 py-8 lg:grid-cols-[minmax(0,1fr)_minmax(320px,460px)]">
      {/* Fondo decorativo */}
      ...
      <div className="relative z-10 mx-auto w-full max-w-[460px]">
        <div className="rounded-2xl border border-stone-200 bg-white p-6 shadow-card sm:p-8">
          <div className="mb-6">
            <h2 className="text-xl font-black text-stone-900">Crear cuenta</h2>
            <p className="mt-1 text-sm text-stone-500">Completá los datos para registrarte</p>
          </div>
          <FormularioRegistro />
          <p className="mt-5 text-center text-sm text-stone-500">
            ¿Ya tenés cuenta?{" "}
            <Link className="font-semibold text-orange-600 transition hover:text-orange-700" to="/login">
              Iniciá sesion
            </Link>
          </p>
        </div>
