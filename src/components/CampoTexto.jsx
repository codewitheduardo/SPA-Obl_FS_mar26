export default function CampoTexto({ label, error, className = "", ...props }) {
  return (
    <label className={`block ${className}`}>
      ...
      <input
        className={`w-full min-w-0 rounded-xl border bg-white px-4 py-2.5 text-sm text-stone-900 outline-none transition-colors duration-150 placeholder:text-stone-400 ${
          error
