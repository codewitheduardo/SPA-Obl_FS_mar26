  ...
  return (
    <div className="mb-8 flex min-w-0 flex-col justify-between gap-4 md:flex-row md:items-end">
      <div className="min-w-0">
        <span className="inline-flex items-center rounded-full bg-orange-50 px-3 py-1 text-[10px] font-bold uppercase tracking-widest text-orange-600 ring-1 ring-orange-100">
          Cook Book
        </span>
        ...
        {descripcion && (
          <p className="mt-2 max-w-2xl text-sm leading-6 text-stone-500">{descripcion}</p>
        )}
      </div>
